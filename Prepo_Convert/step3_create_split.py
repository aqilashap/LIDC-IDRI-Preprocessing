...
path_root = Path('D:/Skripsi/newprepo/preprocessed') # Path ke folder hasil export sebelumnya
df = pd.read_csv(path_root/'annotation.csv') # Baca annotation.csv yang dihasilin sebelumnya juga
...
path_root_out = path_root/'splits' # Output path hasil spliting data
